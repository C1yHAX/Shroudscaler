// winmm.dll = Shroudtopia proxy + OptiScaler loader (Visual Studio / MSVC variant)
//
// MSVC can express the winmm forwarders directly as linker /export directives,
// so no assembly is needed here. Produces a DLL equivalent to the src/ build.
#pragma once
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved)
{
    if (ul_reason_for_call == DLL_PROCESS_ATTACH) {
        ...
        LoadLibraryA("shroudtopia.dll");                 // Shroudtopia mod loader
